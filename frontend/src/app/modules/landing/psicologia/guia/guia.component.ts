...
@Component({
  selector: "app-psicologia-guia",
  templateUrl: "./guia.component.html",
  standalone: true,
  imports: [CommonModule],
})
export class PsicologiaGuiaComponent implements OnInit, AfterViewInit {
  ...
  loadHtmlContent(): void {
    ...
    fetch("/assets/modules/landing/psicologia/guia/guia.html")
