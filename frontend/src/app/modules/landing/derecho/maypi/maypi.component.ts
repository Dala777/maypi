...
@Component({
  selector: "app-derecho-maypi",
  templateUrl: "./maypi.component.html",
  standalone: true,
  imports: [CommonModule],
})
export class DerechoMaypiComponent implements OnInit, AfterViewInit {
  ...
  loadHtmlContent(): void {
    ...
    fetch("/assets/modules/landing/derecho/maypi/maypi.html")
